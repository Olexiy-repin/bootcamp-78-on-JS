...
//   const searchedCar = cars.find((el, idx, arr) => {
//     return el.model.toLowerCase() === model;
//   });

//   return searchedCar === undefined ? `${model} не знайдено!` : { ...searchedCar };
// };
...
//   const searchedCar = cars.find(car => car.model.toLowerCase() === model);
